...
void test(int T)
{
    lli currx,curry,stopx,stopy,i,j;
    ...
    rep(i , 0 , n)
    {
        ...
        if(currx==0 and curry==0) continue;
        else v.pb({currx,curry});
    }
    ...
    rep(i , 0 , v.size())
    {
        ...
        rep(j , 0 , n)
        {
            if(s[j]=='L')
            {
                if(currx-1==v[i].ff and curry==v[i].ss) continue;
                currx--;
            }
            else if(s[j]=='R')
            {
            ...
            {
                if(currx==v[i].ff and curry+1==v[i].ss) continue;
                curry++;
            }
            else if(s[j]=='D')
            {
