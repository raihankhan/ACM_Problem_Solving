...
int main()
{
    ...
    {
        scin(a);
        if(a==1) s1.insert(p[i]);
        if(a==2) s2.insert(p[i]);
        if(a==3) s3.insert(p[i]);
    }
    ...
    while(m--)
    {
        ...
        if(c==1)
        {
            ...
            else
            {
                ...
                pf("%d ",val);
                s1.erase(val);
                if(s2.find(val)!=s2.end()) s2.erase(val);
                if(s3.find(val)!=s3.end()) s3.erase(val);
            }
        }
        if(c==2)
        {
            ...
            else
            {
                ...
                pf("%d ",val);
                s2.erase(val);
                if(s1.find(val)!=s1.end()) s1.erase(val);
                if(s3.find(val)!=s3.end()) s3.erase(val);
            }
        }
        if(c==3)
