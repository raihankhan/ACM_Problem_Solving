...
int main()
{
   ...
   while(t--)
   {
       ...
       if(x>=a and y<=b)
       {
           cout << (b-a+1)-(y-x+1) << endl; //cout << "1" << endl;
       }
       else if(x<a and y<=b and y>=a )
       {
           cout << b-y << endl; //cout << "2" << endl;
       }
       else if(x>=a and y>b and x<=b)
       {
           cout << x-a << endl; //cout << "3" << endl;
       }
       else if(x<a and y>b)
       {
           cout << "0" << endl; //cout << "4" << endl;
       }
       else
       {
           cout << abs(b-a) << endl; //cout << "5" << endl;
       }
