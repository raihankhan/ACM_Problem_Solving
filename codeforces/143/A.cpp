...
int main()
{
    int a1,a2,a3,a4,r1,r2,c1,c2,d1,d2,p;
    ...
    rep(a1 , 1 , 10)
    {
        rep(a2 , 1 , 10)
        {
            rep(a3 , 1 , 10)
            {
                rep(a4 , 1, 10)
                {
                    if(a1+a2==r1 and a3+a4==r2 and a1+a3==c1 and a2+a4==c2 and a1+a4==d1 and a3+a2==d2 and a1!=a2 and a1!=a3 and a1!=a4 and a2!=a3 and a2!=a4 and a3!=a4)
                    {
                        cout << a1 << " " << a2 << endl << a3 << " " << a4 << endl;
                        return 0;
                    }
                }
            }
