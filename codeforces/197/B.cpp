...
void test(int T)
{
    ...
    scin2(n,m);
    veci a(n+3),b(m+3);
    rep(i , 1 , n+2) scin(a[i]);
    rep(i , 1 , m+2) scin(b[i]);

    if(n==m)
    {
        if(b[1]==0)
        {
            if(a[1]>=0) cout << "Infinity" << endl;
        ...
        else
        {
            if(a[1]*b[1]<0)
            {
                cout << "-" << abs(a[1])/gcd(abs(a[1]),abs(b[1])) << "/" << abs(b[1])/gcd(abs(a[1]),abs(b[1])) << endl;
            }
            else
            {
                cout << a[1]/gcd(a[1],b[1]) << "/" << b[1]/gcd(a[1],b[1]) << endl;
            }
        }
    }
    else if(n<m)
    ...
    {
        if(a[1]*b[1]>=0) cout << "Infinity" << endl;
        else cout << "-Infinity" << endl;
    }
