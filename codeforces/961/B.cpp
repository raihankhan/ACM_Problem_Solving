...
///...............................Code Starts Here........................................
lli arr[p5],cum1[p5],cum2[p5],t[p5];
int main()
{
    lli n,k,i,j,p,maxi=0,ind,a,b,ans=0;

    scln2(n,k);
    rep(i , 1 , n+1) scin(arr[i]),cum1[i]+=arr[i]+cum1[i-1];
    rep(i , 1 , n+1) scin(t[i]),cum2[i]+=(t[i]*arr[i])+cum2[i-1];

    rep(i , 1 , n-k+2)
    {
        p=(cum1[i+k-1]-cum1[i-1])-(cum2[i+k-1]-cum2[i-1]);
        if(p>=maxi) maxi=p,ind=i;
    }
