...
int main()
{
    ...
    while(t--)
    {
        ...
        if(arr[0] and arr[1]) tot++,arr[0]--,arr[1]--;
        if(arr[1] and arr[2]) tot++,arr[1]--,arr[2]--;
        if(arr[2] and arr[0]) tot++,arr[2]--,arr[0]--;

        if(arr[0] and arr[1] and arr[2]) tot++;
