...
bool solve(int angle,int moves)
{
    if(moves==n) return angle==0;
    int is_possible=(solve((angle+rot[moves]+360)%360,moves+1)|solve((angle-rot[moves]+360)%360,moves+1));
    return is_possible;
}
int main()
{
