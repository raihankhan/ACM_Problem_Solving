...
lli solve(string s)
{
    lli n=s.length(),i,tot=0,x=0,y=0,prevx=0,prevy=0;
    map< string , bool > mm ;
    string temp1 = "0-0|0-0" , temp2 ;
    ...
    rep(i,0,n)
    {
        ...
        temp1 = strconv(prevx) + "-" +strconv(x) + "|" +  strconv(prevy) + "-" + strconv(y);
        temp2 = strconv(x) + "-" +strconv(prevx) + "|" +  strconv(y) + "-" + strconv(prevy);

        if(mm[ temp1 ] or mm[ temp2 ] )
        {
            tot++;
        }
        else
