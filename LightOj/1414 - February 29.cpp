...
{
    lli t,i,j,p,k;
      string month[15]= {"January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November","December"};
      unordered_map<string,int>mm;
      rep(i,0,12)
    mm[month[i]]=i;
      string month1,month2;
    char comma;
    lli day1,year1,day2,year2;
      cin >>t ;
      rep(k, 1, t+1)
    {
        ...
        cin >> month2 >> day2 >> comma >> year2 ;
          if(mm[month1]>1)
            year1++;
          if(mm[month2]==0 or (mm[month2]==1 and day2<29 ))
            year2--;
          int leaps=0;
          leaps= (year2>>2LL) - (( year1-1 )>>2LL);
        leaps-= (year2/100LL)-((year1-1)/100LL);
        leaps+= (year2/400LL)-((year1-1)/400LL);
          cout << "Case " << k << ": " << leaps << endl;
      }
        #ifdef HOME
